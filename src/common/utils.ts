...
// Polynomial fn generated by extracting points (t, mul) from Roobet's Crash and using python to estimate the polynomial
...
// Roobet's Crash version original publicly available formula
...
export function genMul() {
    ...
    // For example, if x = 20, it means the game crashes at 1 every 20 games on average which is an RTP of 95%
